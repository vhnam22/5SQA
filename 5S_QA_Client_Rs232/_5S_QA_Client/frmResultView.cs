...
public class frmResultView : MetroForm
{
	...
	private readonly string mPortComName = ConfigurationManager.ConnectionStrings["PortComName"].ConnectionString;
	...
	private List<SafeSerialPort> mSerials;
	...
	private void frmResultView_Shown(object sender, EventArgs e)
	{
		...
		Set_dgvMain();
		mForm.Hide();
		if (mComs.Length != mTypes.Length || mComs.Length > mNames.Length)
		{
			MessageBox.Show(Common.getTextLanguage(this, "ErrorConfig"), Common.getTextLanguage(this, "ERROR"), MessageBoxButtons.OK, MessageBoxIcon.Hand);
			Close();
		}
		else
		{
	...
	private void Init_Serial()
	{
		new Task(delegate
		{
			List<COMPortInfo> cOMPortsInfo = COMPortInfo.GetCOMPortsInfo();
			int i;
			for (i = 0; i < mComs.Length; i++)
			{
				COMPortInfo cOMPortInfo = cOMPortsInfo.FirstOrDefault((COMPortInfo x) => x.Description.StartsWith(mComs[i]));
				if (cOMPortInfo != null)
				{
					string text = mTypes[i];
					SafeSerialPort safeSerialPort = null;
					string text2 = text;
					string text3 = text2;
					if (text3 == "HR530")
					{
						safeSerialPort = new SafeSerialPort
						{
							PortName = cOMPortInfo.Name,
							BaudRate = 9600,
							MachineName = mNames[i],
							MachineType = mTypes[i],
							ReadTimeout = 2000
						};
					}
					if (safeSerialPort != null)
					{
						mSerials.Add(safeSerialPort);
					}
				}
			}
			OpenPort();
	...
	private void OpenPort()
	{
		...
		foreach (SafeSerialPort mSerial in mSerials)
		{
			mSerial.DataReceived -= mSerialPort_DataReceived;
			if (!mSerial.IsOpen)
			{
				mSerial.Open();
			}
			Set_imgSignal(mSerial.IsOpen);
			mSerial.DataReceived += mSerialPort_DataReceived;
		}
	}
	...
	{
		SafeSerialPort serial = sender as SafeSerialPort;
		if (!dataProcessing)
		{
			dataProcessing = true;
			processData(serial);
	...
	private void processData(SafeSerialPort serial)
	{
		string text = string.Empty;
		string machineType = serial.MachineType;
		string text2 = machineType;
		if (text2 == "HR530")
		{
			try
			{
			...
			if (text.Length > 0)
			{
				text = MachineFilter.GetResult_HR530(text);
			}
		}
		Set_ResultForRs232(text, serial.MachineName);
	}
	...
	private void Load_Settings()
	{
		...
		mNames = frmLogin.mMachineName.Split(new string[1] { ";" }, StringSplitOptions.RemoveEmptyEntries);
		mTypes = frmLogin.mMachineType.Split(new string[1] { ";" }, StringSplitOptions.RemoveEmptyEntries);
		mComs = mPortComName.Split(new string[1] { ";" }, StringSplitOptions.RemoveEmptyEntries);
		mSerials = new List<SafeSerialPort>();
	}
	...
	private void Set_ResultForRs232(string result, string machineName)
	{
		Invoke((MethodInvoker)delegate
		{
			...
			else
			{
				...
				if (dgvMain.CurrentCell != null && !dgvMain.CurrentCell.ReadOnly && dgvMain.Rows[2].Cells[dgvMain.CurrentCellAddress.X].Value != dgvMain.Rows[3].Cells[dgvMain.CurrentCellAddress.X].Value)
				{
					if (mRemember != result)
					{
						MachineLienceViewModel val = mForm.mMachines.FirstOrDefault((MachineLienceViewModel x) => x.Mark.ToString() == machineName);
						if (val == null)
						{
							dgvMain.CurrentCell.Value = mRemember;
						...
						else
						{
							...
							{
								dgvMain.CurrentCell.Value = result;
	...
	private void dgvMain_CellEndEdit(object sender, DataGridViewCellEventArgs e)
	{
		...
		if (array.Length > 1)
		{
			...
			MachineLienceViewModel val = mForm.mMachines.FirstOrDefault((MachineLienceViewModel x) => x.Mark.ToString() == mark);
			if (val == null)
			{
				dgvMain.CurrentCell.Value = mRemember;
				debugOutput(Common.getTextLanguage(this, "ErrorTool"));
	...
	private void InitializeComponent()
	{
		...
		this.btnRefresh.Size = new System.Drawing.Size(447, 32);
		...
		this.btnShowHeader.Size = new System.Drawing.Size(30, 32);
		...
		this.dgvMain.Size = new System.Drawing.Size(1160, 250);
		...
		this.tpanelTitle.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 32f));
		this.tpanelTitle.Size = new System.Drawing.Size(1160, 34);
		...
		this.lblToolNameDisplay.Size = new System.Drawing.Size(72, 32);
		this.lblToolNameDisplay.TabIndex = 21;
		...
		this.lblCavity.Size = new System.Drawing.Size(19, 32);
		...
		this.lblCavityDisplay.Size = new System.Drawing.Size(44, 32);
		...
		this.lblSample.Size = new System.Drawing.Size(19, 32);
		...
		this.lblSampleDisplay.Size = new System.Drawing.Size(54, 32);
		...
		this.lblTool.Size = new System.Drawing.Size(19, 32);
		...
		this.lblDimNo.Size = new System.Drawing.Size(19, 32);
		...
		this.lblJudgeDisplay.Size = new System.Drawing.Size(75, 32);
		...
		this.lblDimNoDisplay.Size = new System.Drawing.Size(52, 32);
		...
		this.lblToolDisplay.Size = new System.Drawing.Size(35, 32);
		...
		this.lblJudge.Size = new System.Drawing.Size(19, 32);
		...
		this.tpanelButton.ColumnCount = 10;
		...
		this.tpanelButton.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
		this.tpanelButton.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 20f));
		this.tpanelButton.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 20f));
		...
		this.tpanelButton.Controls.Add(this.btnComplete, 9, 0);
		...
		this.lblToolName.Size = new System.Drawing.Size(19, 32);
		this.lblToolName.TabIndex = 22;
		...
		this.lblToolTypeDisplay.Size = new System.Drawing.Size(39, 32);
		this.lblToolTypeDisplay.TabIndex = 23;
		...
		this.lblToolType.Size = new System.Drawing.Size(19, 32);
		this.lblToolType.TabIndex = 24;
		...
		this.lblResultDisplay.Size = new System.Drawing.Size(45, 32);
		this.lblResultDisplay.TabIndex = 25;
		...
		this.lblResult.Size = new System.Drawing.Size(19, 32);
