...
public class frmLogin : MetroForm
{
	...
	public static string mMachineType = ConfigurationManager.ConnectionStrings["MachineType"].ConnectionString;
	...
	private ToolStripSeparator toolStripSeparatorMapper;

	private ToolStripMenuItem main_mapperToolStripMenuItem;
	...
	public frmLogin()
	{
		...
		{
			IME = (string.IsNullOrEmpty(GetIME().Trim()) ? ("null#" + mMachineType) : (GetIME() + "#" + mMachineType))
		};
	}
	...
	private void Init()
	{
		Text = Text + " (" + mMachineName + "#" + mMachineType + ")";
	...
	private void LoadLiences()
	{
		new Task(delegate
		{
			...
			try
			{
				ResponseDto result = client.GetsAsync((object)client.IME, "/api/Machine/GetLiences/{id}").Result;
	...
	private void main_mapperToolStripMenuItem_Click(object sender, EventArgs e)
	{
		mSearchMain.btnSearch.Select();
		Cursor.Current = Cursors.WaitCursor;
		RequestViewModel request = (from DataRow x in mSearchMain.dataTable.Rows
		...
		new frmMapperView(request).ShowDialog();
		if (isEdit)
		{
			main_refreshToolStripMenuItem.PerformClick();
		}
	...
	private void btnLogin_Click(object sender, EventArgs e)
	{
		...
		try
		{
			...
			toolStripSeparatorMapper.Visible = User.Role == RoleWeb.SuperAdministrator;
			main_mapperToolStripMenuItem.Visible = User.Role == RoleWeb.SuperAdministrator;
	...
	private void InitializeComponent()
	{
		...
		this.toolStripSeparatorMapper = new System.Windows.Forms.ToolStripSeparator();
		this.main_mapperToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
		...
		this.contextMenuStripRequest.Items.AddRange(new System.Windows.Forms.ToolStripItem[8] { this.main_refreshToolStripMenuItem, this.toolStripSeparator1, this.main_viewToolStripMenuItem, this.toolStripSeparator3, this.main_resultToolStripMenuItem, this.main_completeToolStripMenuItem, this.toolStripSeparatorMapper, this.main_mapperToolStripMenuItem });
		...
		this.toolStripSeparatorMapper.Name = "toolStripSeparatorMapper";
		resources.ApplyResources(this.toolStripSeparatorMapper, "toolStripSeparatorMapper");
		this.main_mapperToolStripMenuItem.Name = "main_mapperToolStripMenuItem";
		resources.ApplyResources(this.main_mapperToolStripMenuItem, "main_mapperToolStripMenuItem");
		this.main_mapperToolStripMenuItem.Click += new System.EventHandler(main_mapperToolStripMenuItem_Click);
		...
		resources.ApplyResources(this.InputDate, "InputDate");
