...
public class LargeValueFormatter extends ValueFormatter {
    ...
    private String makePretty(double number) {
        ...
        String r2 = r.replaceAll("E[0-9][0-9]", this.mSuffix[Integer.valueOf(Character.getNumericValue(r.charAt(r.length() - 2)) + "" + Character.getNumericValue(r.charAt(r.length() - 1))).intValue() / 3]);
        while (true) {
