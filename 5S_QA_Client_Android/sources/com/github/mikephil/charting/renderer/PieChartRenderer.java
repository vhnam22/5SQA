...
public class PieChartRenderer extends DataRenderer {
    ...
    public float calculateMinimumRadiusForSpacedSlice(MPPointF center, float radius, float angle, float arcStartPointX, float arcStartPointY, float startAngle, float sweepAngle) {
        ...
        return (float) (((double) (radius - ((float) ((Math.sqrt(Math.pow((double) (arcEndPointX - arcStartPointX), 2.0d) + Math.pow((double) (arcEndPointY - arcStartPointY), 2.0d)) / 2.0d) * Math.tan(((180.0d - ((double) angle)) / 2.0d) * 0.017453292519943295d))))) - Math.sqrt(Math.pow((double) ((mPPointF.x + (((float) Math.cos((double) (angleMiddle * 0.017453292f))) * radius)) - ((arcEndPointX + arcStartPointX) / 2.0f)), 2.0d) + Math.pow((double) ((mPPointF.y + (((float) Math.sin((double) (0.017453292f * angleMiddle))) * radius)) - ((arcEndPointY + arcStartPointY) / 2.0f)), 2.0d)));
    }
        ...
        while (j5 < entryCount2) {
            ...
            if (Math.abs(iPieDataSet.getEntryForIndex(j5).getY()) <= Utils.FLOAT_EPSILON) {
                ...
                if (drawRoundedSlices) {
                    ...
                    float x = center4.x + ((radius3 - roundedRadius) * ((float) Math.cos((double) (startAngleOuter2 * 0.017453292f))));
                    entryCount = entryCount2;
                    drawAngles = drawAngles2;
                    float y = center4.y + ((radius3 - roundedRadius) * ((float) Math.sin((double) (startAngleOuter2 * 0.017453292f))));
                    float f = x;
                ...
                if (!drawInnerArc) {
                    ...
                    if (accountForSliceSpacing) {
                        ...
                        radius = radius3;
                        center2 = center4;
                        float minSpacedRadius = calculateMinimumRadiusForSpacedSlice(center4, radius3, sliceAngle * phaseY, f2, arcStartPointY, startAngleOuter4, sweepAngleOuter);
                        ...
                        j = j2;
                        visibleAngleCount4 = visibleAngleCount2;
                        float f4 = startAngleOuter3;
                        radius = radius3;
                        circleBox = circleBox3;
                        float f5 = arcStartPointX2;
                        i = 1;
                        float f6 = innerRadius2;
                    }
                    float sliceSpaceAngleInner = (visibleAngleCount4 == i || innerRadius2 == 0.0f) ? 0.0f : sliceSpace / (innerRadius2 * 0.017453292f);
                    ...
                    if (sweepAngleOuter < 360.0f || sweepAngleOuter % 360.0f > Utils.FLOAT_EPSILON) {
                        ...
                        if (drawRoundedSlices) {
                            float x2 = center3.x + ((radius - roundedRadius) * ((float) Math.cos((double) (endAngleInner * 0.017453292f))));
                            rotationAngle = rotationAngle4;
                            float y2 = center3.y + ((radius - roundedRadius) * ((float) Math.sin((double) (endAngleInner * 0.017453292f))));
                            float f7 = sliceSpaceAngleInner;
            ...
            while (i3 < highlightArr.length) {
                ...
                if (index >= drawAngles3.length) {
                    ...
                    if (set == null) {
                        ...
                        float innerRadius4 = userInnerRadius;
                        ...
                        if (sweepAngleOuter < 360.0f || sweepAngleOuter % 360.0f > Utils.FLOAT_EPSILON) {
                            ...
                            float f = shift;
                            this.mPathBuffer.moveTo(center2.x + (((float) Math.cos((double) (startAngleShifted * 0.017453292f))) * highlightedRadius), center2.y + (((float) Math.sin((double) (startAngleShifted * 0.017453292f))) * highlightedRadius));
                            this.mPathBuffer.arcTo(highlightedCircleBox2, startAngleShifted, sweepAngleShifted);
                        } else {
                            int i6 = index;
                            innerRadius = innerRadius4;
                            drawAngles2 = drawAngles3;
                            this.mPathBuffer.addCircle(center2.x, center2.y, highlightedRadius, Path.Direction.CW);
                            visibleAngleCount = visibleAngleCount2;
                            float f2 = shift;
                        }
                        ...
                        if (accountForSliceSpacing) {
                            ...
                            center = center2;
                            sliceSpaceRadius = calculateMinimumRadiusForSpacedSlice(center2, radius, sliceAngle * phaseY, center2.x + (((float) Math.cos((double) (startAngleOuter * 0.017453292f))) * radius), center2.y + (((float) Math.sin((double) (startAngleOuter * 0.017453292f))) * radius), startAngleOuter, sweepAngleOuter);
                        } else {
                        ...
                        if (!drawInnerArc2) {
                            ...
                            int visibleAngleCount3 = visibleAngleCount;
                            float sliceSpaceAngleInner = (visibleAngleCount3 == 1 || innerRadius3 == 0.0f) ? 0.0f : sliceSpace / (innerRadius3 * 0.017453292f);
                            ...
                            float endAngleInner = startAngleInner + sweepAngleInner;
                            if (sweepAngleOuter < 360.0f || sweepAngleOuter % 360.0f > Utils.FLOAT_EPSILON) {
                                float f8 = startAngleInner;
                                float f9 = sliceSpaceAngleInner;
                                drawInnerArc = drawInnerArc2;
                                this.mPathBuffer.lineTo(center.x + (((float) Math.cos((double) (endAngleInner * 0.017453292f))) * innerRadius3), center.y + (((float) Math.sin((double) (endAngleInner * 0.017453292f))) * innerRadius3));
                                this.mPathBuffer.arcTo(this.mInnerRectBuffer, endAngleInner, -sweepAngleInner);
                            } else {
                                int i7 = visibleAngleCount3;
