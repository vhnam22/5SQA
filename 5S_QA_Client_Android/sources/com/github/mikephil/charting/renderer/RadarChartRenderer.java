            ...
            if (!shouldDrawValues(dataSet2)) {
                ...
                while (j2 < dataSet2.getEntryCount()) {
                    ...
                    if (dataSet2.isDrawValuesEnabled()) {
                        ...
                        float f2 = iconsOffset.y - yoffset3;
                    ...
                    if (entry.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                        ...
                        Utils.getPosition(center, (entry.getY() * factor * phaseY) + pOut3.y, (((float) j) * sliceangle * phaseX) + this.mChart.getRotationAngle(), pIcon);
                        pIcon.y += pOut3.x;
    ...
    public void drawWeb(Canvas c) {
        ...
        for (int j = 0; j < labelCount; j++) {
            ...
            while (i2 < ((RadarData) this.mChart.getData()).getEntryCount()) {
                ...
                float f3 = f2;
                c.drawLine(f, f3, p2out.x, p2out.y, this.mWebPaint);
                i2++;
