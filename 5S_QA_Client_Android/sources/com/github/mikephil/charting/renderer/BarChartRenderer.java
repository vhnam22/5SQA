                            ...
                            if (vals2 != null) {
                                ...
                                if (!this.mViewPortHandler.isInBoundsY(buffer3.buffer[bufferIndex + 1])) {
                                    ...
                                    if (entry2.getIcon() == null || !dataSet.isDrawIconsEnabled()) {
                                        ...
                                        Utils.drawImage(c, icon2, (int) (x2 + iconsOffset.x), (int) (buffer3.buffer[bufferIndex + 1] + (entry2.getY() >= 0.0f ? posOffset : negOffset) + iconsOffset.y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                        float f10 = x2;
                        ...
                        while (true) {
                            ...
                            if (!this.mViewPortHandler.isInBoundsY(buffer2.buffer[j2 + 1])) {
                                ...
                                if (entry3.getIcon() != null && dataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(c, icon3, (int) (x3 + iconsOffset2.x), (int) ((val2 >= 0.0f ? buffer.buffer[j + 1] + posOffset : buffer.buffer[j + 3] + negOffset) + iconsOffset2.y), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                }
                            }
                            j2 = j + 4;
