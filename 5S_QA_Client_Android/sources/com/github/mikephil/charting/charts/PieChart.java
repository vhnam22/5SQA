...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private void calcAngles() {
        ...
        boolean hasMinAngle = f != 0.0f && ((float) entryCount) * f <= this.mMaxAngle;
        ...
        for (int i3 = 0; i3 < ((PieData) this.mData).getDataSetCount(); i3++) {
            ...
            for (int j = 0; j < set.getEntryCount(); j++) {
                ...
                if (cnt == 0) {
                    this.mAbsoluteAngles[cnt] = drawAngle;
                } else {
                    float[] fArr = this.mAbsoluteAngles;
                    fArr[cnt] = fArr[cnt - 1] + drawAngle;
                }
                cnt++;
            }
        }
        if (hasMinAngle) {
            for (int i4 = 0; i4 < entryCount; i4++) {
                ...
                if (i4 == 0) {
                    ...
                    fArr2[i4] = fArr2[i4 - 1] + minAngles[i4];
                }
            }
