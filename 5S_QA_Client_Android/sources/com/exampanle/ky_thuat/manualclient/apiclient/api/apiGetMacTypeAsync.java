...
public class apiGetMacTypeAsync extends AsyncTask<String, String, List<MetadataValueViewModel>> {
    ...
    public apiGetMacTypeAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/MetadataValue/NoAuthorGets";
    }
