...
import com.exampanle.ky_thuat.manualclient.apiclient.model.MoldingViewModel;
...
public class apiGetMoldingAsync extends AsyncTask<String, String, List<MoldingViewModel>> {
    ...
    public apiGetMoldingAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/MoldingMachine/Gets";
    }

    /* access modifiers changed from: protected */
    public List<MoldingViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<MoldingViewModel>>() {
            }.getType());
        }
