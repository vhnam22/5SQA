...
public class apiGetMachineForToolAsync extends AsyncTask<String, String, List<MachineForToolViewModel>> {
    ...
    public apiGetMachineForToolAsync(Context context2, UUID id, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Machine/GetForTools/" + id;
    }

    /* access modifiers changed from: protected */
    public List<MachineForToolViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<MachineForToolViewModel>>() {
            }.getType());
        }
