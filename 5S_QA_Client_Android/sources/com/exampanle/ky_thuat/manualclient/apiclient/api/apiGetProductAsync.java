...
public class apiGetProductAsync extends AsyncTask<String, String, List<ProductViewModel>> {
    ...
    public apiGetProductAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Product/Gets";
    }

    /* access modifiers changed from: protected */
    public List<ProductViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<ProductViewModel>>() {
            }.getType());
        }
