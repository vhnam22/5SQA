...
public class apiGetCommentAsync extends AsyncTask<String, String, List<CommentViewModel>> {
    ...
    public apiGetCommentAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Comment/Gets";
    }

    /* access modifiers changed from: protected */
    public List<CommentViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<CommentViewModel>>() {
            }.getType());
        }
