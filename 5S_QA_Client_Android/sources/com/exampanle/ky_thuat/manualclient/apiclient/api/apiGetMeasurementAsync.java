...
public class apiGetMeasurementAsync extends AsyncTask<String, String, List<ResultViewModel>> {
    ...
    public apiGetMeasurementAsync(Context context2, UUID id, List<String> obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Measurement/Gets/" + id;
    }
