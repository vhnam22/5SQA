...
public class apiGetToolAsync extends AsyncTask<String, String, List<ToolViewModel>> {
    ...
    public apiGetToolAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Tool/Gets";
    }

    /* access modifiers changed from: protected */
    public List<ToolViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<ToolViewModel>>() {
            }.getType());
        }
