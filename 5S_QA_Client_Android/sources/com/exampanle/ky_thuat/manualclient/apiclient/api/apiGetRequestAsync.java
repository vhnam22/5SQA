...
public class apiGetRequestAsync extends AsyncTask<String, String, List<RequestViewModel>> {
    ...
    public apiGetRequestAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Request/Gets";
    }

    /* access modifiers changed from: protected */
    public List<RequestViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<RequestViewModel>>() {
            }.getType());
        }
