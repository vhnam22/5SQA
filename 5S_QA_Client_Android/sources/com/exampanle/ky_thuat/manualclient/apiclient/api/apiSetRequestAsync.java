...
public class apiSetRequestAsync extends AsyncTask<String, String, RequestViewModel> {
    ...
    public apiSetRequestAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Request/Save";
    }
