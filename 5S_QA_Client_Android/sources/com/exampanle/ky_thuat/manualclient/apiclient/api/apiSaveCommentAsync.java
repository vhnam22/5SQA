...
public class apiSaveCommentAsync extends AsyncTask<String, String, Boolean> {
    ...
    public apiSaveCommentAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Comment/Save";
    }
