...
public class apiSetResultAsync extends AsyncTask<String, String, ResultViewModel> {
    ...
    public apiSetResultAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/RequestResult/Save";
    }

    /* access modifiers changed from: protected */
    public ResultViewModel doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (ResultViewModel) this.json.deserialize(this.json.serialize(responseDto.getData()), ResultViewModel.class);
        }
