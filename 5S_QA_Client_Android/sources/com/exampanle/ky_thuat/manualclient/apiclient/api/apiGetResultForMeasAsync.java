...
public class apiGetResultForMeasAsync extends AsyncTask<String, String, List<ResultViewModel>> {
    ...
    public apiGetResultForMeasAsync(Context context2, UUID id, UUID idmeas) {
        this.context = context2;
        this.url = "/api/RequestResult/GetForMeass/" + id + "/" + idmeas;
    }
