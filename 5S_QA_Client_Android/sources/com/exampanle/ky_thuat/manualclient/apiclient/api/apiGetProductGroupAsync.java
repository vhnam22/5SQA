...
public class apiGetProductGroupAsync extends AsyncTask<String, String, List<ProductGroupViewModel>> {
    ...
    public apiGetProductGroupAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/ProductGroup/Gets";
    }

    /* access modifiers changed from: protected */
    public List<ProductGroupViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<ProductGroupViewModel>>() {
            }.getType());
        }
