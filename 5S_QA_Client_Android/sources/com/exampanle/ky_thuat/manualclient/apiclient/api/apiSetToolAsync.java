...
public class apiSetToolAsync extends AsyncTask<String, String, ToolViewModel> {
    ...
    public apiSetToolAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Tool/Save";
    }

    /* access modifiers changed from: protected */
    public ToolViewModel doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (ToolViewModel) this.json.deserialize(this.json.serialize(responseDto.getData()), ToolViewModel.class);
        }
