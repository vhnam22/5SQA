...
public class apiGetOrderAsync extends AsyncTask<String, String, List<OrderViewModel>> {
    ...
    public apiGetOrderAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/Order/Gets";
    }

    /* access modifiers changed from: protected */
    public List<OrderViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<OrderViewModel>>() {
            }.getType());
        }
