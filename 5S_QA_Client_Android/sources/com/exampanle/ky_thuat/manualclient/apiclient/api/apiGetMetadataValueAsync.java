...
public class apiGetMetadataValueAsync extends AsyncTask<String, String, List<MetadataValueViewModel>> {
    ...
    public apiGetMetadataValueAsync(Context context2, Object obj2) {
        this.obj = obj2;
        this.json = new JSON();
        this.context = context2;
        this.url = "/api/MetadataValue/Gets";
    }

    /* access modifiers changed from: protected */
    public List<MetadataValueViewModel> doInBackground(String... strings) {
        try {
        ...
        if (responseDto.isSuccess().booleanValue()) {
            return (List) this.json.deserialize(this.json.serialize(responseDto.getData()), new TypeToken<List<MetadataValueViewModel>>() {
            }.getType());
        }
