...
public abstract class OneDReader implements Reader {
    ...
    private com.google.zxing.Result doDecode(com.google.zxing.BinaryBitmap r22, java.util.Map<com.google.zxing.DecodeHintType, ?> r23) throws com.google.zxing.NotFoundException {
        ...
        L_0x0046:
            ...
            r12 = r22
            com.google.zxing.common.BitArray r9 = r12.getBlackRow(r11, r9)     // Catch:{ NotFoundException -> 0x00e9 }
            r13 = 0
        L_0x0055:
            r0 = 2
        ...
        L_0x0077:
            r14 = r21
            com.google.zxing.Result r0 = r14.decodeRow(r11, r9, r3)     // Catch:{ ReaderException -> 0x00d1 }
            if (r13 != r5) goto L_0x00d0
            com.google.zxing.ResultMetadataType r15 = com.google.zxing.ResultMetadataType.ORIENTATION     // Catch:{ ReaderException -> 0x00d1 }
            r16 = 180(0xb4, float:2.52E-43)
            java.lang.Integer r5 = java.lang.Integer.valueOf(r16)     // Catch:{ ReaderException -> 0x00d1 }
            r0.putMetadata(r15, r5)     // Catch:{ ReaderException -> 0x00d1 }
            com.google.zxing.ResultPoint[] r5 = r0.getResultPoints()     // Catch:{ ReaderException -> 0x00d1 }
            if (r5 == 0) goto L_0x00d0
            com.google.zxing.ResultPoint r15 = new com.google.zxing.ResultPoint     // Catch:{ ReaderException -> 0x00d1 }
            r16 = r2
            float r2 = (float) r1
            r18 = r5[r4]     // Catch:{ ReaderException -> 0x00cc }
            float r18 = r18.getX()     // Catch:{ ReaderException -> 0x00cc }
            float r18 = r2 - r18
            ...
            r15 = 1
            r17 = r5[r15]     // Catch:{ ReaderException -> 0x00c8 }
            float r17 = r17.getX()     // Catch:{ ReaderException -> 0x00c8 }
            float r2 = r2 - r17
            float r2 = r2 - r19
            r17 = r5[r15]     // Catch:{ ReaderException -> 0x00c8 }
            float r1 = r17.getY()     // Catch:{ ReaderException -> 0x00c8 }
            r4.<init>(r2, r1)     // Catch:{ ReaderException -> 0x00c8 }
            r5[r15] = r4     // Catch:{ ReaderException -> 0x00c8 }
            goto L_0x00d0
        L_0x00c8:
            r0 = move-exception
            goto L_0x00d7
