...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isShifting(this.labelVisibilityMode, visibleCount) || !this.itemHorizontalTranslationEnabled) {
            ...
            int childWidth = Math.min(width / i2, this.activeItemMaxWidth);
            ...
            int i4 = width - activeWidth;
            if (inactiveCount != 0) {
                i2 = inactiveCount;
            }
            int inactiveWidth = Math.min(i4 / i2, this.inactiveItemMaxWidth);
            int extra2 = (width - activeWidth) - (inactiveWidth * inactiveCount);
            int i5 = 0;
            while (i5 < totalCount) {
                if (getChildAt(i5).getVisibility() != i) {
                    int[] iArr2 = this.tempChildWidths;
                    int i6 = i5 == this.selectedItemPosition ? activeWidth : inactiveWidth;
                    iArr2[i5] = i6;
                    if (extra2 > 0) {
                        iArr2[i5] = i6 + 1;
                        extra2--;
