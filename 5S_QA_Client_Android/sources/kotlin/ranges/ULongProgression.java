...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1244getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public final long m1266getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1267getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m206constructorimpl(j ^ ULong.m206constructorimpl(j >>> 32))) * 31) + ((int) ULong.m206constructorimpl(j2 ^ ULong.m206constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sb2;
        if (this.step > 0) {
            sb2 = sb.append(ULong.m251toStringimpl(this.first)).append("..").append(ULong.m251toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sb2 = sb.append(ULong.m251toStringimpl(this.first)).append(" downTo ").append(ULong.m251toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
