...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static short[] m364constructorimpl(short[] sArr) {
    ...
    public static boolean m367equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m378unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m367equalsimpl(this.storage, obj);
    }
    ...
    public final /* synthetic */ short[] m378unboximpl() {
        return this.storage;
    }
    ...
    public final /* bridge */ boolean contains(Object element) {
        ...
        return m377containsxj2QHRw(((UShort) element).m361unboximpl());
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m363constructorimpl(int size) {
        return m364constructorimpl(new short[size]);
    }

    /* renamed from: get-Mh2AYeg  reason: not valid java name */
    public static final short m369getMh2AYeg(short[] arg0, int index) {
        return UShort.m312constructorimpl(arg0[index]);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m374set01HTLdE(short[] arg0, int index, short value) {
        arg0[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m370getSizeimpl(short[] arg0) {
        return arg0.length;
    }
    ...
    public static java.util.Iterator<UShort> m373iteratorimpl(short[] arg0) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return UShort.m306boximpl(m379nextMh2AYeg());
        }
        ...
        public short m379nextMh2AYeg() {
            ...
            if (i < sArr.length) {
                this.index = i + 1;
                return UShort.m312constructorimpl(sArr[i]);
            }
    ...
    public boolean m377containsxj2QHRw(short element) {
        return m365containsxj2QHRw(this.storage, element);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public static boolean m365containsxj2QHRw(short[] arg0, short element) {
    ...
    public static boolean m366containsAllimpl(short[] arg0, Collection<UShort> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        ...
        for (Object it : $this$all$iv) {
            if (!(it instanceof UShort) || !ArraysKt.contains(arg0, ((UShort) it).m361unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
    ...
    public static boolean m372isEmptyimpl(short[] arg0) {
