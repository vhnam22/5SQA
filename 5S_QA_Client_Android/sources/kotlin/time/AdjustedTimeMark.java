...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1341minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1485minusLRDsOJo(this, duration);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1340getAdjustmentUwyO8pc() {
    ...
    public long m1339elapsedNowUwyO8pc() {
        return Duration.m1382minusLRDsOJo(this.mark.m1482elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1342plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1383plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
