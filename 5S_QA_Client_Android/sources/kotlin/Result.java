...
public final class Result<T> implements Serializable {
    ...
    public static boolean m35equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m43unboximpl());
    }
    ...
    public static final boolean m41isSuccessimpl(Object arg0) {
        return !(arg0 instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m40isFailureimpl(Object arg0) {
        return arg0 instanceof Failure;
    }

    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m38getOrNullimpl(Object arg0) {
        if (m40isFailureimpl(arg0)) {
            return null;
        }
        return arg0;
    }
    ...
    public static final Throwable m37exceptionOrNullimpl(Object arg0) {
    ...
    public static String m42toStringimpl(Object arg0) {
        if (arg0 instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m34constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m34constructorimpl(ResultKt.createFailure(exception));
        }
    }
