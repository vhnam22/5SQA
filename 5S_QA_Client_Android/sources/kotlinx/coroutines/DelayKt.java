...
public final class DelayKt {
    ...
    public static final Object m1511delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1512toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1512toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1346compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1449getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1365getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
