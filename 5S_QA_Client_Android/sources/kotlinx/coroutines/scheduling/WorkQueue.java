...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue victim) {
        ...
        for (int start = victim.consumerIndex; start != end; start++) {
            ...
            if (value != null) {
                if ((value.taskContext.getTaskMode() == 1) && ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(buffer2, index, value, (Object) null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue victim, boolean blockingOnly) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(lastScheduledTask$FU, victim, lastScheduled, (Object) null));
