...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int index) {
            ...
            } while (!ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, oldValue, (Object) null));
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(value instanceof Marked)) {
                            if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, value, ConcurrentWeakMapKt.mark(value))) {
                                break;
                            }
                        } else {
