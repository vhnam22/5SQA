...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m34constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
    ...
    public static final void m1555installSignalHandler$lambda1(Signal it) {
