...
class AndroidPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        ...
        OptionalMethod<Socket> getAlpnSelectedProtocol3 = null;
        try {
            Class.forName("android.net.Network");
            getAlpnSelectedProtocol3 = new OptionalMethod<>(cls, "getAlpnSelectedProtocol", new Class[0]);
            Class[] clsArr = {cls};
            getAlpnSelectedProtocol2 = getAlpnSelectedProtocol3;
            setAlpnProtocols2 = new OptionalMethod<>((Class<?>) null, "setAlpnProtocols", clsArr);
