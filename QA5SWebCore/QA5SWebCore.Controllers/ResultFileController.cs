...
{
	private readonly IResultFileService _service;

	public ResultFileController(IResultFileService service)
	{
		_service = service;
	}
	...
	[HttpPost]
	public async Task<ResponseDto> Save([FromBody] ResultFileViewModel model)
	{
