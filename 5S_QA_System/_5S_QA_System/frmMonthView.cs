...
public class frmMonthView : MetroForm
{
	private Guid mId;
	...
	private mSearchMonth mSearchMain;
	...
	private void frmMonthView_Shown(object sender, EventArgs e)
	{
		mSearchMain.Init();
	...
	private void frmMonthView_FormClosing(object sender, FormClosingEventArgs e)
	{
		GC.Collect();
	}

	private void frmMonthView_FormClosed(object sender, FormClosedEventArgs e)
	{
	...
	public void load_AllData()
	{
		...
		try
		{
			...
			queryArgs.Predicate = "Date>=@0 && Date<=@1 && ProductId=@2 && !Status.Contains(@3) && !Status.Contains(@4)";
	...
	private void main_viewallToolStripMenuItem_Click(object sender, EventArgs e)
	{
		...
		foreach (DataRow row in mSearchMain.dataTableFilter.Rows)
		{
			if (bool.Parse(row["IsSelect"].ToString()))
			{
				list.Add(new ExportDto
				{
					...
					Type = "All",
					Page = "All",
					TemplateId = (string.IsNullOrEmpty(mSearchMain.cbbTemplate.Text) ? Guid.Empty : Guid.Parse(mSearchMain.cbbTemplate.SelectedValue.ToString()))
				});
			}
		}
		...
		try
		{
			string text = "/api/Template/ExportAllOnFile";
			if (mSearchMain.cbSingle.Checked)
			{
				text = "/api/Template/Export";
			}
			ExportExcelDto exportExcelDto = frmLogin.client.ExportAsync((object)list, text).Result ?? throw new Exception(Common.getTextLanguage(this, "wHasntFile"));
			string text2 = exportExcelDto.FileName.Replace("\"", "").Replace("\\", "").Replace("/", "");
			if (Path.GetExtension(text2).Equals(".zip"))
			{
				saveFileDialogMain.FileName = text2;
				if (saveFileDialogMain.ShowDialog().Equals(DialogResult.OK))
				{
					text2 = saveFileDialogMain.FileName;
					ByteArrayToFile(text2, exportExcelDto.Value);
					Common.ExecuteBatFile(text2);
				}
				return;
			}
			string text3 = Path.Combine("C:\\Windows\\Temp\\5SQA_System", "VIEWS");
			Directory.CreateDirectory(text3);
			text2 = Path.Combine(text3, text2);
			if (File.Exists(text2))
			{
				File.Delete(text2);
			}
			Cursor.Current = Cursors.WaitCursor;
			if (ByteArrayToFile(text2, exportExcelDto.Value))
			{
				WebBrowser webBrowser = new WebBrowser();
				webBrowser.Navigate(text2, newWindow: false);
			}
		}
		catch (Exception ex)
		{
			...
			{
				object value = ((object)item).GetType().GetProperty(text5).GetValue(item, null);
				if (value != null)
				{
			...
			if (ex.InnerException is ApiException { StatusCode: var statusCode })
			{
				...
				{
					debugOutput("ERR: " + (string.IsNullOrEmpty(text4) ? ex.Message.Replace("\n", "") : text4));
					MessageBox.Show(string.IsNullOrEmpty(text4) ? ex.Message : text4, Common.getTextLanguage(this, "ERROR"), MessageBoxButtons.OK, MessageBoxIcon.Hand);
				}
			}
			else
			{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(_5S_QA_System.frmMonthView));
		...
		this.mSearchMain = new _5S_QA_System.mSearchMonth();
		...
		this.dataGridViewTextBoxColumn5.DataPropertyName = "ProductStage";
		this.dataGridViewTextBoxColumn5.FillWeight = 30f;
		this.dataGridViewTextBoxColumn5.HeaderText = "Stage name";
		...
		this.dataGridViewTextBoxColumn6.HeaderText = "Product code";
		...
		this.dataGridViewTextBoxColumn8.DataPropertyName = "ProductImageUrl";
		this.dataGridViewTextBoxColumn8.HeaderText = "Product image";
		this.dataGridViewTextBoxColumn8.Name = "dataGridViewTextBoxColumn8";
		this.dataGridViewTextBoxColumn8.ReadOnly = true;
		this.dataGridViewTextBoxColumn8.Visible = false;
		this.dataGridViewTextBoxColumn9.DataPropertyName = "ProductCavity";
		this.dataGridViewTextBoxColumn9.HeaderText = "Product cavity";
		...
		this.dataGridViewTextBoxColumn11.HeaderText = "Q.ty";
		this.dataGridViewTextBoxColumn11.Name = "dataGridViewTextBoxColumn11";
		this.dataGridViewTextBoxColumn11.ReadOnly = true;
		this.dataGridViewTextBoxColumn11.Visible = false;
		this.dataGridViewTextBoxColumn12.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
		this.dataGridViewTextBoxColumn12.DataPropertyName = "Lot";
		...
		this.dataGridViewTextBoxColumn14.DataPropertyName = "Intention";
		this.dataGridViewTextBoxColumn14.FillWeight = 20f;
		this.dataGridViewTextBoxColumn14.HeaderText = "Intention";
		...
		this.ProductStage.Visible = false;
		...
		base.Name = "frmMonthView";
		base.Padding = new System.Windows.Forms.Padding(20, 70, 20, 20);
		this.Text = "5S QA System * EXPORT";
		base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(frmMonthView_FormClosing);
		base.FormClosed += new System.Windows.Forms.FormClosedEventHandler(frmMonthView_FormClosed);
		base.Load += new System.EventHandler(frmMonthView_Load);
		base.Shown += new System.EventHandler(frmMonthView_Shown);
