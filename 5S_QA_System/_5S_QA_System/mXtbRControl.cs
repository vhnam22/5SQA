...
public class mXtbRControl : UserControl
{
	...
	public mXtbRControl(CommonCpk commonCpk, List<DataCpk> dataCpks, List<ChartViewModel> models)
	{
		InitializeComponent();
	...
	private void mXtbRControl_Load(object sender, EventArgs e)
	{
		Init();
	}
	...
	private void Init()
	{
		...
		chartMain.ChartAreas[1].AxisX.Minimum = 1.0;
		chartMain.ChartAreas[1].AxisX.Maximum = mDataCpks.Count;
		source = new List<double> { mCommonCpk.R, mCommonCpk.RUCL, mCommonCpk.AveR };
		num = Math.Round((mCommonCpk.Upper - mCommonCpk.Lower) * 0.1, 4, MidpointRounding.AwayFromZero);
		num2 = 0.0;
		num3 = Math.Round(source.Max(), 4, MidpointRounding.AwayFromZero) + num;
		chartMain.ChartAreas[1].AxisY.Minimum = num2;
		chartMain.ChartAreas[1].AxisY.Maximum = num3;
		chartMain.ChartAreas[1].AxisY.Interval = Math.Round((num3 - num2) / 5.0, 4, MidpointRounding.AwayFromZero);
		...
		if (mCommonCpk.Unit == "°")
		{
			...
			chartMain.ChartAreas[1].AxisY.CustomLabels.Clear();
			for (double num5 = chartMain.ChartAreas[1].AxisY.Minimum; num5 <= chartMain.ChartAreas[1].AxisY.Maximum; num5 += chartMain.ChartAreas[1].AxisY.Interval)
			{
				chartMain.ChartAreas[1].AxisY.CustomLabels.Add(num5 - chartMain.ChartAreas[1].AxisY.Interval / 2.0, num5 + chartMain.ChartAreas[1].AxisY.Interval / 2.0, Common.ConvertDoubleToDegrees(num5, uniformity: true));
			}
		}
		DrawInformation();
	...
	private void DrawInformation()
	{
		...
		num = (int)((float)chartMain.Height * chartMain.ChartAreas[1].Position.Y / 100f);
		num2 = (int)((float)chartMain.Height * chartMain.ChartAreas[1].Position.Height / 100f);
		num3 = (int)((float)num + (float)num2 * chartMain.ChartAreas[1].InnerPlotPosition.Y / 100f);
		num4 = (int)((float)num3 + (float)num2 * (chartMain.ChartAreas[1].InnerPlotPosition.Y + chartMain.ChartAreas[1].InnerPlotPosition.Height) / 100f);
		list = new List<double> { mCommonCpk.R, mCommonCpk.RUCL, mCommonCpk.AveR }.OrderByDescending((double x) => x).ToList();
		TransparentLabel transparentLabel6 = new TransparentLabel
		{
		...
		panelInfor.Controls.Add(transparentLabel6);
		transparentLabel6.Location = new Point(0, GetLocationY(num3 + transparentLabel6.Height / 2, num4 - transparentLabel6.Height / 2, 3, list.IndexOf(mCommonCpk.R)) - transparentLabel6.Height / 2);
		TransparentLabel transparentLabel7 = new TransparentLabel
		{
		...
		panelInfor.Controls.Add(transparentLabel7);
		transparentLabel7.Location = new Point(0, GetLocationY(num3 + transparentLabel7.Height / 2, num4 - transparentLabel7.Height / 2, 3, list.IndexOf(mCommonCpk.RUCL)) - transparentLabel7.Height / 2);
		TransparentLabel transparentLabel8 = new TransparentLabel
		{
		...
		panelInfor.Controls.Add(transparentLabel8);
		transparentLabel8.Location = new Point(0, GetLocationY(num3 + transparentLabel8.Height / 2, num4 - transparentLabel8.Height / 2, 3, list.IndexOf(mCommonCpk.AveR)) - transparentLabel8.Height / 2);
	}
	...
	private void chartMain_MouseMove(object sender, MouseEventArgs e)
	{
		if (mPreHit != null)
		{
			...
			if (mPreHit.Series.Name.Equals("Data") || mPreHit.Series.Name.Equals("Range"))
			{
		...
		if (mPreHit != null)
		{
			...
			if (mPreHit.Series.Name.Equals("Data") || mPreHit.Series.Name.Equals("Range") || mPreHit.Series.Name.Equals("ErrorBars"))
			{
	...
	private void InitializeComponent()
	{
		...
		this.panelChart.Size = new System.Drawing.Size(1000, 313);
		...
		series13.LabelBackColor = System.Drawing.Color.Black;
		series13.LabelForeColor = System.Drawing.Color.White;
		series13.LabelFormat = "0.####";
		...
		series14.LabelBackColor = System.Drawing.Color.Black;
		series14.LabelForeColor = System.Drawing.Color.White;
		series14.LabelFormat = "0.####";
		...
		series15.LabelBackColor = System.Drawing.Color.Black;
		series15.LabelForeColor = System.Drawing.Color.White;
		series15.LabelFormat = "0.####";
		...
		this.chartMain.Size = new System.Drawing.Size(908, 311);
		...
		this.panelInfor.Size = new System.Drawing.Size(90, 311);
		...
		base.Name = "mXtbRControl";
		base.Size = new System.Drawing.Size(1000, 430);
		base.Load += new System.EventHandler(mXtbRControl_Load);
