...
public class frmRequestAdd : MetroForm
{
	...
	private DateTimePicker dtpInputDate;

	public frmRequestAdd(Form frm, DataTable data, Guid id, DateTime dateTime, bool isadd = true)
	{
		InitializeComponent();
	...
	private void frmRequestAdd_FormClosed(object sender, FormClosedEventArgs e)
	{
		...
		if (!isClose)
		{
			((frmRequestView)mForm).load_AllData(mDateTime);
		}
	}
	...
	private void load_AutoComplete()
	{
		...
		txtSupplier.AutoCompleteCustomSource = Common.getAutoComplete(mData, "Supplier");
	}
	...
	private void load_Data()
	{
		...
		if (dataRow.ItemArray.Length != 0)
		{
			...
			txtSupplier.Text = dataRow["Supplier"].ToString();
			cbbType.Text = dataRow["Type"].ToString();
			if (!string.IsNullOrEmpty(dataRow["InputDate"].ToString()))
			{
				dtpInputDate.Checked = true;
				dtpInputDate.Value = DateTime.Parse(dataRow["InputDate"].ToString());
			}
			if (!isAdd)
			{
	...
	private void loadSampleWithAQL()
	{
		...
		try
		{
			...
			List<LimitViewModel> objectToList = Common.getObjectToList<LimitViewModel>(result);
			int? num = objectToList.Max((LimitViewModel x) => x.Sample);
			cbbSample.Text = num?.ToString();
		}
		catch (Exception ex)
		{
	...
	private void btnComfirm_Click(object sender, EventArgs e)
	{
		try
		{
			...
			RequestViewModel requestViewModel = new RequestViewModel
			{
				...
				Supplier = (string.IsNullOrEmpty(txtSupplier.Text) ? null : txtSupplier.Text),
			...
			if (dtpInputDate.Checked)
			{
				requestViewModel.InputDate = dtpInputDate.Value;
			}
			if (isAdd || !MessageBox.Show(Common.getTextLanguage(this, "wSureEdit"), Common.getTextLanguage(this, "QUESTION"), MessageBoxButtons.YesNo, MessageBoxIcon.Question).Equals(DialogResult.No))
			{
				...
				((frmRequestView)mForm).isThis = true;
				if (!isAdd)
				{
				...
				isClose = false;
				if (isAdd && MessageBox.Show(Common.getTextLanguage(this, "wAddSuccessful"), Common.getTextLanguage(this, "QUESTION"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
				{
					txtCode.Text = set_Code();
				}
				else
		...
		{
			((frmRequestView)mForm).isThis = false;
	...
	private void btnTypeAdd_Click(object sender, EventArgs e)
	{
		...
		list.Add(typeof(frmSubView));
		Common.closeForm(list);
		new frmSubView(this, (FormType)10).Show();
	}
	...
	private void btnLineAdd_Click(object sender, EventArgs e)
	{
		...
		list.Add(typeof(frmSubView));
		Common.closeForm(list);
		new frmSubView(this, (FormType)11).Show();
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(_5S_QA_System.frmRequestAdd));
		...
		this.btnConfirm.Location = new System.Drawing.Point(0, 501);
		...
		this.cbbSample.Location = new System.Drawing.Point(96, 322);
		...
		this.cbbType.Size = new System.Drawing.Size(318, 24);
		...
		this.btnTypeAdd.Location = new System.Drawing.Point(318, 0);
		...
		this.cbbLine.Location = new System.Drawing.Point(0, 0);
		this.cbbLine.Name = "cbbLine";
		this.cbbLine.Size = new System.Drawing.Size(318, 24);
		this.cbbLine.TabIndex = 1;
		this.toolTipMain.SetToolTip(this.cbbLine, "Select or enter line");
		this.btnLineAdd.BackColor = System.Drawing.Color.Gainsboro;
		this.btnLineAdd.Cursor = System.Windows.Forms.Cursors.Hand;
		this.btnLineAdd.Dock = System.Windows.Forms.DockStyle.Right;
		this.btnLineAdd.FlatAppearance.BorderSize = 0;
		this.btnLineAdd.FlatAppearance.MouseDownBackColor = System.Drawing.SystemColors.Control;
		this.btnLineAdd.FlatAppearance.MouseOverBackColor = System.Drawing.Color.SkyBlue;
		this.btnLineAdd.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
		this.btnLineAdd.Location = new System.Drawing.Point(318, 0);
		this.btnLineAdd.Name = "btnLineAdd";
		this.btnLineAdd.Size = new System.Drawing.Size(24, 24);
		this.btnLineAdd.TabIndex = 2;
		this.btnLineAdd.Text = "+";
		this.toolTipMain.SetToolTip(this.btnLineAdd, "Goto manage line");
		this.btnLineAdd.UseVisualStyleBackColor = false;
		this.btnLineAdd.Click += new System.EventHandler(btnLineAdd_Click);
		...
		this.panelMain.Size = new System.Drawing.Size(450, 531);
		...
		this.tableLayoutPanel2.Controls.Add(this.dtpInputDate, 1, 9);
		this.tableLayoutPanel2.Controls.Add(this.txtSupplier, 1, 10);
		this.tableLayoutPanel2.Controls.Add(this.lblSupplier, 0, 10);
		this.tableLayoutPanel2.Controls.Add(this.lblInputDate, 0, 9);
		this.tableLayoutPanel2.Controls.Add(this.panel3, 1, 7);
		...
		this.tableLayoutPanel2.Controls.Add(this.lblType, 0, 12);
		...
		this.tableLayoutPanel2.Controls.Add(this.lblModifiedBy, 1, 17);
		this.tableLayoutPanel2.Controls.Add(this.lblModifiBy, 0, 17);
		this.tableLayoutPanel2.Controls.Add(this.lblCreatedBy, 1, 16);
		this.tableLayoutPanel2.Controls.Add(this.lblModifi, 0, 15);
		this.tableLayoutPanel2.Controls.Add(this.lblModified, 1, 15);
		this.tableLayoutPanel2.Controls.Add(this.lblCreated, 1, 14);
		this.tableLayoutPanel2.Controls.Add(this.lblCreateBy, 0, 16);
		this.tableLayoutPanel2.Controls.Add(this.lblCreate, 0, 14);
		this.tableLayoutPanel2.Controls.Add(this.lblSample, 0, 11);
		...
		this.tableLayoutPanel2.Controls.Add(this.cbbSample, 1, 11);
		...
		this.tableLayoutPanel2.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 28f));
		this.tableLayoutPanel2.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 28f));
		this.tableLayoutPanel2.Size = new System.Drawing.Size(442, 495);
		this.tableLayoutPanel2.TabIndex = 1;
		this.tableLayoutPanel2.TabStop = true;
		this.panel3.Controls.Add(this.cbbLine);
		this.panel3.Controls.Add(this.btnLineAdd);
		this.panel3.Dock = System.Windows.Forms.DockStyle.Fill;
		this.panel3.Location = new System.Drawing.Point(96, 206);
		this.panel3.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
		this.panel3.Name = "panel3";
		this.panel3.Size = new System.Drawing.Size(342, 24);
		...
		this.panel2.Location = new System.Drawing.Point(96, 351);
		this.panel2.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
		this.panel2.Name = "panel2";
		this.panel2.Size = new System.Drawing.Size(342, 24);
		this.panel2.TabIndex = 13;
		this.panel2.TabStop = true;
		this.lblType.AutoSize = true;
		this.lblType.Dock = System.Windows.Forms.DockStyle.Fill;
		this.lblType.Location = new System.Drawing.Point(4, 349);
		...
		this.lblModifiedBy.Location = new System.Drawing.Point(96, 466);
		...
		this.lblCreatedBy.Location = new System.Drawing.Point(96, 437);
		...
		this.lblModified.Location = new System.Drawing.Point(96, 408);
		...
		this.lblCreated.Location = new System.Drawing.Point(96, 379);
		...
		this.lblSample.Location = new System.Drawing.Point(4, 320);
		...
		this.panelMainResize.Size = new System.Drawing.Size(3, 501);
		...
		this.dgvMain.Columns.AddRange(this.No, this.Code, this.name, this.Value, this.UnitName, this.Upper, this.Lower, this.MachineTypeName, this.Id);
		...
		this.dgvMain.Size = new System.Drawing.Size(510, 293);
		...
		this.lblInputDate.Location = new System.Drawing.Point(4, 262);
		this.lblInputDate.Name = "lblInputDate";
		this.lblInputDate.Size = new System.Drawing.Size(85, 28);
		this.lblInputDate.TabIndex = 37;
		...
		this.lblSupplier.Location = new System.Drawing.Point(4, 291);
		this.lblSupplier.Name = "lblSupplier";
		this.lblSupplier.Size = new System.Drawing.Size(85, 28);
		...
		this.txtSupplier.Location = new System.Drawing.Point(96, 294);
		this.txtSupplier.Name = "txtSupplier";
		this.txtSupplier.Size = new System.Drawing.Size(342, 22);
		this.txtSupplier.TabIndex = 11;
		this.toolTipMain.SetToolTip(this.txtSupplier, "Please enter intention");
		this.txtSupplier.Leave += new System.EventHandler(txtNormal_Leave);
		this.dtpInputDate.Checked = false;
		this.dtpInputDate.Dock = System.Windows.Forms.DockStyle.Fill;
		this.dtpInputDate.Format = System.Windows.Forms.DateTimePickerFormat.Short;
		this.dtpInputDate.Location = new System.Drawing.Point(96, 265);
		this.dtpInputDate.Name = "dtpInputDate";
		this.dtpInputDate.ShowCheckBox = true;
		this.dtpInputDate.Size = new System.Drawing.Size(342, 22);
		this.dtpInputDate.TabIndex = 10;
		this.toolTipMain.SetToolTip(this.dtpInputDate, "Select input date");
		base.AutoScaleDimensions = new System.Drawing.SizeF(8f, 16f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(1000, 621);
