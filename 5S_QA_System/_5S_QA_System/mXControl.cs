...
public class mXControl : UserControl
{
	...
	public mXControl(CommonCpk commonCpk, List<DataCpk> dataCpks, List<ChartViewModel> models)
	{
		InitializeComponent();
	...
	private void mXControl_Load(object sender, EventArgs e)
	{
		Init();
	}
	...
	private void InitializeComponent()
	{
		...
		base.Load += new System.EventHandler(mXControl_Load);
